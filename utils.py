...
def parse_args():
    ...
    p.add_argument('--data', help='The dataset to use.', type=str, default="/home/ihossain/ISMAIL/Datasets/data/gen_apigraph_drebin")
    ...
    p.add_argument('--mlp-hidden', default='100-100',
