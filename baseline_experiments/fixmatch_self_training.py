...
def active_learning_fixmatch(
    ...
    supcon_loss_fn = SupConLoss(temperature=args.supconTemp)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--supconTemp', default=0.07, type=float, help='Supervised Contrastive learning temperature')
    ...
    append_to_strategy(f"_supcon_{args.lambda_supcon}")
