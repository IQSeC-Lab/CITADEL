...
def train_flexmatch_drift_eval(model, optimizer, X_labeled, y_labeled, X_unlabeled, \
    ...
    for epoch in tqdm(range(epochs), desc="Training FlexMatch"):
        ...
        for _ in tqdm(range(len(labeled_loader)), desc="FlexMatch Applying..."):
            try:
...
# nohup python train.py > /home/ihossain/ISMAIL/SSL-malware/baseline_experiments/flexmatch/output.log 2>&1 &