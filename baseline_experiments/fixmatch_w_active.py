...
def train_fixmatch_drift_eval(
    ...
    num_classes=2, threshold=0.85, lambda_u=1.0, epochs=50, retrain_epochs=10, batch_size=64
):
    ...
    metrics_df.to_csv("fixmatch_w_al_aug_0.1_metrics.csv", index=False)
    ...
    plot_f1_fnr(metrics_df['year'], metrics_df['f1'], metrics_df['fnr'], save_path="results/f1_fnr_{strategy}_aug_0.1.png")
