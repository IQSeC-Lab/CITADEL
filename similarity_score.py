...
def load_data_and_model(args):
    ...
    ENC_MODEL_PATH = "/home/mhaque3/myDir/SSL-malware/models/gen_apigraph_drebin/simple_enc_classifier_lr0.003_sgd_.pth"
...
def pesudo_labeling(args):
    ...
    df.to_csv('/home/mhaque3/myDir/SSL-malware/pseudo_labels/pseudo_labels_output.csv', index=True, header=True)
